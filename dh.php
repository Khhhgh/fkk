...
$bot_id = "6446376504"; // ايدي بوتك

$admmm = "5997009476";

$tbbots = "ARLOUefg"; 

$API_KEY = "6446376504:AAG1W2Rs6O-EuPRN3SGPMdramHqR3QgEjEc";
...
$Dev = array("$admmm","0");// حط ايدي مطور ثاني بدل الاصفار
@$channel = "cptsha8";
@$token = API_KEY;
$buyy = "@$tbbots";
...
ادخل للقناة لتتعلم اكثر » @cptsha8
",
...
'disable_web_page_preview'=>true,
        ...
        'reply_markup'=>json_encode([
          'inline_keyboard'=>[  
                [['text'=>'• اصنع بوت ، لك 🔱','url'=>'https://t.me/KENAEBOT']],
               ]
        ])
    ]);
}
...
$ARLOUefg = "799273845";//هنا ايديك
$TTK       = $message->message_id;
$Kickmetxt = file_get_contents("kickme.txt");
if ($text =="اطردني" or $text == "ادفرني" or $text == "مغادره" and $from_id != $ARLOUefg){
...
bot('banChatMember',[
  ...
  "chat_id"=>$chat_id,
  "text" => "
📛❉ يلا مع السلامه عند امك مع حظر انتبه ترجع 😒🖕🏿
  ", 'parse_mode'=>"HTML",
  "reply_to_message_id"=>$TTK,
  ]);
...
if ($text =="اطردني" and $from_id == $ARLOUefg){
 bot("sendMessage",[
 "chat_id"=>$chat_id,
 "text"=>"
• لااستطيع طردك مطوري •
...
elseif (strpos($text  , "/unbanall ") !== false or strpos($text  , "الغاء حظر العام ") !== false) {
if (in_array($from_id,$Dev)) {
$text = str_replace(['/unbanall ','الغاء حظر العام '],'',$text );
$stat = file_get_contents("https://api.telegram.org/bot$token/getChatMember?chat_id=$text&user_id=".$text);
$statjson = json_decode($stat, true);
$name = $statjson['result']['user']['first_name'];
$username = $statjson['result']['user']['username'];
...
if($text =="السورس" || $text =="سورس"){
	...
	'chat_id'=>$chat_id,
	'text'=>"
👨‍✈️❉ اهلا بك عزيزي في سورس ALBASHA
💢❉ السورس الاول بلغه php
💢❉ السورس الاول اكتمالا في اليمن والدول العربيه
💢❉ لايحتاج سرفرات او VPS
💢❉ سريع جدا ومميزات خياليه
••┉┉┉┉┉┉┉┉┉┉┉┉┉•• 
💢❉ قم بمراسله المطور لصنع بوت مدفوع خاص بك › @ARLOUefg ✅
📮✣لصنع بوتك مجاني من مصنع بوتات ي ‹ @albasha_1_bot › 👨🏽‍💻
",
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>'','url'=>"https://telegram.me/The_security_of_his_country_bot?start"]
              ] 
              ],
        ])
            ]);
